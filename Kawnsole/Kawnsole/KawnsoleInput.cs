...
namespace Kawnsole {
	public struct KawnsoleInput {
		...
		public KawnsoleInput(char Chr, KeyCode Key, bool Ctrl = false, bool Shift = false, bool Alt = false) {
			this.Chr = Chr;
			this.Key = Key;
			this.Ctrl = Ctrl;
			this.Alt = Alt;
	...
	public static class KawnsoleInputConverters {
		public static ConsoleKeyInfo ToConsoleKeyInfo(this KawnsoleInput CCI) {
